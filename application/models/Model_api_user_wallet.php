...
class Model_api_user_wallet extends MY_Model {

	
	private $primary_key 	= 'id';
	private $table_name 	= 'user_wallet';
	private $field_search 	= ['id', 'wallet_code', 'wallet_qrcode', 'user_id'];
	private $user_restriction = '';
	private $user_restriction_columns = 'user_id';
	private $has_relations = 0;
	private $default_select_field =  ['id', 'wallet_code', 'wallet_qrcode', 'user_id'];
...
/* End of file Model_user_wallet.php */
/* Location: ./application/models/Model_user_wallet.php */
