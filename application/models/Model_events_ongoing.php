...
class Model_events_ongoing extends MY_Model {

				private $primary_key    = NULL;
		private $table_name 	= 'events_ongoing';
	...
	public function count_all($q = null, $field = null)
	{
		...
		if (!empty($field)) {
				$where .= "(" . "events_ongoing.".$field . " LIKE '%" . $q . "%' )";
		}
	        ...
	        $search = $this->search_filter();
                ...
                if($this->apply_user_filter()) {
                        ...
                        $where .= " events_ongoing.created_by = {$this->aauth->get_user_id()} ";
                }
...
/* End of file Model_events_ongoing.php */
/* Location: ./application/models/Model_events_ongoing.php */
