...
class Model_events_future extends MY_Model {

				private $primary_key    = NULL;
		private $table_name 	= 'events_future';
	...
	public function count_all($q = null, $field = null)
	{
		...
		if (!empty($field)) {
				$where .= "(" . "events_future.".$field . " LIKE '%" . $q . "%' )";
		}
	        ...
	        $search = $this->search_filter();
                ...
                if($this->apply_user_filter()) {
                        ...
                        $where .= " events_future.created_by = {$this->aauth->get_user_id()} ";
                }
...
/* End of file Model_events_future.php */
/* Location: ./application/models/Model_events_future.php */
