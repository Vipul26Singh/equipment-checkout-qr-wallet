		...
		<?php if(!empty($crud_nav_menu)) {
			...
			<tr>
                           ...
                           if (!$this->crud_builder->getFieldFile($field) AND !$this->crud_builder->getFieldFileMultiple($field) AND !$relation){ 
                            ...
                            ?><td><a style="text-decoration: underline;" class="label-default" href='{php_open_tag_echo} site_url("administrator/<?= $relation['relation_table']; ?>/view/{$<?= $table_name?>-><?= $relation['relation_value']; ?> }"); {php_close_tag}'> {php_open_tag_echo} _ent($<?= $table_name; ?>-><?= $relation['relation_label']; ?>); {php_close_tag} </a> </td>
               ...
               <div class="row">
                  <div class="col-md-8">
                     ...
                     <div class="col-sm-1 padd-left-0 ">
                        <button type="submit" class="btn btn-sm btn-success btn-raised form-group" name="sbtn" id="sbtn" value="Apply" title="{php_open_tag_echo} cclang('filter_search'); {php_close_tag}">
                        Filter
                        </button>
                     </div>
                     <div class="col-sm-1 padd-left-0 ">
                        <a class="form-group btn btn-flat btn-default" name="reset" id="reset" value="Apply" href="{php_open_tag_echo} base_url('administrator/<?= $table_name; ?>');{php_close_tag}" title="{php_open_tag_echo} cclang('reset_filter'); {php_close_tag}">
                        <i class="fa fa-undo"> {php_open_tag_echo} cclang('reset_filter'); {php_close_tag}</i>
                        </a>
                     </div>
                  </div>
                  <?= form_close(); ?>
