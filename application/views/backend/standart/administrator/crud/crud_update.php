      ...
      <div class="col-md-12">
         <div class="box box-warning">
			...
			<div class="col-xs-3">
			   ...
			   <th width="20" rowspan="2" valign="midle" style="vertical-align: middle; text-align: center;">Exportable</th>
			    ...
			    <td class="detail_page">
            			<center><input class="flat-red check" type="checkbox" <?= !empty($row->field_filterable) && $row->field_filterable == 'yes' ? 'checked' : ''; ?> name="crud[<?=$i; ?>][<?=$row->field_name; ?>][field_filterable]" value="yes"></center>
         		     </td>
			    <td class="detail_page">
                                <center><input class="flat-red check" type="checkbox" <?= !empty($row->field_exportable) && $row->field_exportable == 'yes' ? 'checked' : ''; ?> name="crud[<?=$i; ?>][<?=$row->field_name; ?>][field_exportable]" value="yes"></center>
                             </td>
                           <td>
                              <div class="col-md-12">
                                 <div class="form-group ">
		...
		<div class="wrapper-crud col-sm-12">
			...
			<div class="form-group col-sm-12">
                     		...
                     		<div class="col-sm-8">
                        		<input type="text" class="form-control" name="redirect_add" id="redirect_add" value="<?= $crud->redirect_add; ?>">
                     		</div>
                  	</div>	
			<div class="form-group col-sm-12">
                                <label for="label" class="col-sm-2 control-label">Redirect on Update</label>
                                <div class="col-sm-8">
                                        <input type="text" class="form-control" name="redirect_update" id="redirect_update" value="<?= $crud->redirect_update; ?>">
                                </div>
                        </div>
		</div>
		<div class="wrapper-crud">
			...
			<table class="table table-responsive table table-bordered table-striped"  id="diagnosis_list">
			   ...
			   <th width="250" rowspan="2" valign="midle" style="vertical-align: middle; text-align: center;">Link</th>
				...
				<tbody>
                        		<?php $i=0; foreach ($crud_nav_menu as $row){  $i++; ?>
                        		<tr>
                           			<td  class="dragable">
                              				<i class="fa fa-bars fa-lg text-muted"></i>
						...
						<td>
                           				<div style="margin-bottom: -10px;">
                              				...
                              				<input type="text" class="crud-input-initial" name="crud_nav_menu[<?=$i; ?>][nav_menu_name]" placeholder="<?= $row->nav_menu_name; ?>" value="<?= $row->nav_menu_name; ?>">

                           			</td>

						<td class="column">
                                                        <input class="flat-red check" type="checkbox" <?= $row->show_list == 'yes' ? 'checked' : ''; ?> name="crud_nav_menu[<?=$i; ?>][show_list]" value="yes">
                                                </td>

						<td class="column">
                                                        <input class="flat-red check" type="checkbox" <?= $row->show_add == 'yes' ? 'checked' : ''; ?> name="crud_nav_menu[<?=$i; ?>][show_add]" value="yes">
                                                </td>

                                                <td class="column">
                                                        <input class="flat-red check" type="checkbox" <?= $row->show_edit == 'yes' ? 'checked' : ''; ?> name="crud_nav_menu[<?=$i; ?>][show_edit]" value="yes">
                                                </td>

                                                <td class="column">
                                                        <input class="flat-red check" type="checkbox" <?= $row->show_view == 'yes' ? 'checked' : ''; ?> name="crud_nav_menu[<?=$i; ?>][show_view]" value="yes">
                                                </td>

						<td>
							<input type="text" class="crud-input-initial" name="crud_nav_menu[<?=$i; ?>][nav_menu_link]" value="<?= $row->nav_menu_link; ?>">
						</td>
	
						<td>
                                                        <select  class="form-control" name="crud_nav_menu[<?=$i; ?>][link_column]" tabi-ndex="5" data-placeholder="Select Table" >
                                                                <option value=""></option>
                                                                <?php foreach ($crud_field as $col_detail): ?>
                                                                        <option <?= $col_detail->field_name == $row->link_column ? 'selected' : ''; ?> value="<?= $col_detail->field_name ?>"><?= $col_detail->field_name; ?></option>
                                                                <?php endforeach; ?>
                                                        </select>
                                                </td>	

						<td class="column">
                              				<input class="flat-red check" type="checkbox" <?= $row->is_active == '1' ? 'checked' : ''; ?> name="crud_nav_menu[<?=$i; ?>][is_active]" value="yes">
                           			</td>
					...
					<tr>
						...
						<td class="column">
                                                ...
                                                <td>
                                                        <select  class="form-control" name="crud_nav_menu[<?=$i; ?>][link_column]" tabi-ndex="5" data-placeholder="Select Column" >
                                                                <option value=""></option>
                                                                <?php foreach ($crud_field as $col_detail): ?>
                                                                        <option value="<?= $col_detail->field_name ?>"><?= $col_detail->field_name; ?></option>
                                                                <?php endforeach; ?>
                                                        </select>
                                                </td>
