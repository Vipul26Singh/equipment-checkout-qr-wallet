...
include_once APPPATH."helpers/Gettext/src/autoloader.php";
include_once APPPATH."helpers/cldr-to-gettext-plural-rules/src/autoloader.php";
...
class CI_Locale
{
	...
	var $lang_allowed = array("en" => "english","es" => "spanish","fr" => "french","de" => "german","it" => "italian","pt" => "portuguese","ru" => "russian","ch" => "chinese"); // Languages translated
	...
	public function load($lang = 'en')
	{
           ...
           $lang_allowed = array("en" => "english","es" => "spanish","fr" => "french","de" => "german","it" => "italian","pt" => "portuguese","ru" => "russian","ch" => "chinese"); // Languages translated
            if(!empty($lang)){
                $lang_pre = $lang;
            }else{
                $lang_pre = 'en';
