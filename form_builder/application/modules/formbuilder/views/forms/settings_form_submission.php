    ...
    <div class="row">
        ...
        <div class="col-md-6">
                    ...
                    <label for=""><?php echo __('url after submitting form ','FRocket_admin'); ?>   
                     ...
                     <span class="alert alert-warning"><?php echo __('you need to enable page redirection first and add http or https at the beginning of the url','FRocket_admin'); ?></span>
