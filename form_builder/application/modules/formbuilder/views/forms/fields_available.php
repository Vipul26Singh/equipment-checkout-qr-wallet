                            ...
                            <ul class="uiform-list-fields">
                                ...
                                <li>
                                    <a class="uiform-draggable-field uiform-button1 uiform-multipleselect" 
                                       ...
                                       href="javascript:void(0);">
                                      <?php echo __('Select Multiple ','FRocket_admin'); ?>
                                    </a>
                                </li>
                                <li>
                            ...
                            <ul class="uiform-list-fields">
                                ...
                                <li>
                                    <a class="uiform-draggable-field uiform-button1 uiform-customhtml" 
                                       ...
                                       href="javascript:void(0);">
                                       <i class="fa fa-align-justify"></i> <?php echo __('Custom Html','FRocket_admin'); ?>
                                    </a>
                            ...
                            <ul class="uiform-list-fields">
                                ...
                                <li>
                                    <a class="uiform-draggable-field uiform-button1 uiform-imageupload" 
                                       ...
                                       href="javascript:void(0);">
                                      <i class="fa fa-file-image-o"></i> <?php echo __('Image Upload','FRocket_admin'); ?>
                                    </a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <ul class="uiform-list-fields">
                                ...
                                <li>
                                    <a class="uiform-draggable-field uiform-button1 uiform-colorpicker" 
                                       ...
                                       href="javascript:void(0);">
                                       <i class="fa fa-eyedropper"></i> <?php echo __('Color Picker','FRocket_admin'); ?>
                                    </a>
                                </li>
                                <li>
                                    <a class="uiform-draggable-field uiform-button1 uiform-timepicker" 
                                       ...
                                       href="javascript:void(0);">
                                       <i class=" glyphicon glyphicon-time"></i> <?php echo __('Time Picker','FRocket_admin'); ?>
                                    </a>
                                </li>
                                <li>
                                    <a class="uiform-draggable-field uiform-button1 uiform-datetime" 
                                       ...
                                       href="javascript:void(0);">
                                       <?php echo __('Date and Time','FRocket_admin'); ?>
                                    </a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <ul class="uiform-list-fields">
                                ...
                                <li>
                                    <a class="uiform-draggable-field uiform-button1 uiform-customhtml" 
                                       ...
                                       href="javascript:void(0);">
                                       <?php echo __('Prepend/Append','FRocket_admin'); ?>
                                    </a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <ul class="uiform-list-fields">
                                ...
                                <li>
                                    <a class="uiform-draggable-field uiform-button1 uiform-heading2" 
                                       ...
                                       href="javascript:void(0);">
                                       <?php echo __('Heading H2','FRocket_admin'); ?>
                                    </a>
                                ...
                                <li>
                                    <a class="uiform-draggable-field uiform-button1 uiform-heading3" 
                                       ...
                                       href="javascript:void(0);">
                                       <?php echo __('Heading H3','FRocket_admin'); ?>
                                    </a>
                                ...
                                <li>
                                    <a class="uiform-draggable-field uiform-button1 uiform-heading3" 
                                       ...
                                       href="javascript:void(0);">
                                       <?php echo __('Heading H4','FRocket_admin'); ?>
                                    </a>
                                ...
                                <li>
                                    <a class="uiform-draggable-field uiform-button1 uiform-heading3" 
                                       ...
                                       href="javascript:void(0);">
                                       <?php echo __('Heading H5','FRocket_admin'); ?>
                                    </a>
                                ...
                                <li>
                                    <a class="uiform-draggable-field uiform-button1 uiform-heading3" 
                                       ...
                                       href="javascript:void(0);">
                                       <?php echo __('Heading H6','FRocket_admin'); ?>
                                    </a>
                                </li>
                            </ul>
                        </div>
              ...
              <fieldset>
                    ...
                    <div class="uiform-fieldset-inner">
                        <div class="row">
                            <ul class="uiform-list-fields">
                                <li>
                                    <a class="uiform-draggable-field uiform-button1 uiform-switch" 
                                       data-type="40" 
                                       onclick="javascript:rocketform.mainfields_addFieldToForm(this,40);"
                                       href="javascript:void(0);">
                                       <?php echo __('Switch','FRocket_admin'); ?>
                                    </a>
                                </li>
                                <li>
                                    <a class="uiform-draggable-field uiform-button1 uiform-dcheckbox" 
                                       data-type="41" 
                                       onclick="javascript:rocketform.mainfields_addFieldToForm(this,41);"
                                       href="javascript:void(0);">
                                       <?php echo __('Dyn Checkbox','FRocket_admin'); ?>
                                    </a>
                                </li>
                                <li>
                                    <a class="uiform-draggable-field uiform-button1 uiform-dradiobutton" 
                                       data-type="42" 
                                       onclick="javascript:rocketform.mainfields_addFieldToForm(this,42);"
                                       href="javascript:void(0);">
                                       <?php echo __('Dyn RadioBtn','FRocket_admin'); ?>
                                    </a>
                                </li>
                                <li>
                                    <a class="uiform-draggable-field uiform-button1 uiform-panelfld" 
                                       data-type="31" 
                                       onclick="javascript:rocketform.mainfields_addFieldToForm(this,31);"
                                       href="javascript:void(0);">
                                       <?php echo __('Panel','FRocket_admin'); ?>
                                    </a>
                                </li>
                            </ul>
                        </div>
