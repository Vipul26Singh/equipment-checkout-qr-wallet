        ...
        <div class="widget widget-padding span12">
            ...
            <div class="widget-body">
                <div id="uiform-listform-options">
                    ...
                    <div class="uiform-listform-options-col">
                         <a class="btn btn-sm btn-warning uiform-confirmation-func-action" 
                    ...
                    <div class="uiform-listform-options-col">
                         <a class="btn btn-sm btn-info uiform-confirmation-func-action" 
                    ...
                    <div class="uiform-listform-options-col">
                        <a class="btn btn-sm btn-danger uiform-confirmation-func-action" 
                    ...
                    <div class="uiform-listform-options-col">
                       <a class="btn btn-sm btn-success uiform-confirmation-func-action" 
                    ...
                    <thead>
                        <tr>
                            ...
                            <th 
                                ...
                                ><?php echo __('Code','FRocket_admin');?></th>
...
<?php foreach ($query as $row): ?>
                        <tr>
                            ...
                            <td>
                                <a href="javascript:void(0);" onclick="rocketform.form_getcode(<?php echo $row->fmb_id;?>);" class="btn btn-sm btn-warning">
                          <?php echo __('Get widget code','FRocket_admin')?></a>
                            </td>
    ...
    ?>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <li><a 
                                           class="guidetour-flist-del btn btn-sm btn-danger uiform-confirmation-func-action"
