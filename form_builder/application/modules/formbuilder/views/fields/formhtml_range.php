...
<div class="rockfm-input4-wrap">
        <input class="rockfm-input4-slider" 
                ...
                data-slider-min="<?php echo $input4['set_min'];?>" 
                data-slider-max="<?php echo $input4['set_max'];?>"
                data-slider-step="<?php echo $input4['set_step'];?>"
                data-slider-value="[<?php echo $input4['set_range1'];?>,<?php echo $input4['set_range2'];?>]"
                name="uiform_fields[<?php echo $id;?>]"
                value="[<?php echo $input4['set_range1'];?>,<?php echo $input4['set_range2'];?>]"
                />
    </div>
