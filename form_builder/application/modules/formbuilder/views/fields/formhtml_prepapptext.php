...
<div class="input-group">
        <div class="input-group-addon rockfm-inp-preptxt"><?php echo urldecode($input['prepe_txt']);?></div>
        ...
        <div class="input-group-addon rockfm-inp-apptxt"><?php echo urldecode($input['append_txt']);?></div>
    </div>
...
<div id="rockfm_<?php echo $id;?>"  
     ...
     data-typefield="30" 
     class="rockfm-prepapptext rockfm-field 
