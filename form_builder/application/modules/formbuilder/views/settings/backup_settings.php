                   ...
                   <div class="form-group">
                       ...
                       ><span class="fa fa-question-circle"></span></a>
                           <button type="button"
                                   ...
                                   class="btn btn-primary"><?php echo __('Create backup','FRocket_admin');?></button>
                       </div>
                   </div>
                   <div class="space20"></div>
                   <div class="form-group">
...
endforeach; 
    ?>
                   ...
                   <div class="row">
                       ...
                       <div class="col-md-6">
                            <button type="submit" class="btn btn-primary" value="Submit"><i class="fa fa-upload"></i> <?php echo __('Upload Backup','FRocket_admin'); ?></button>
