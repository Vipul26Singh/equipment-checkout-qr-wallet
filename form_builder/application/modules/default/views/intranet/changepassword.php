                                        ...
                                        <div class="widget form-signin">
                                            ...
                                            <div class="widget-body clearfix" style="padding:25px;">
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <input name="username" class="form-control col-md-12" value="<?php echo $use_login;?>" readonly type="text" id="inputEmail" placeholder="Username">
                                                   
                                                </div>
                                                <div class="form-group">
                                                    
                                                        <input name="password" class="form-control col-md-12" type="password" id="inputPassword" placeholder="Password">
                                                    <input name="pass_token" type="hidden" value="<?php echo $pass_token;?>">
                                                </div>
                                                <div class="space10"></div>
                                                <div class="form-group">
                                                    
                                                        <input name="cpassword" class="form-control col-md-12" type="password" id="inputPassword2" placeholder="<?php echo __('Confirm Password','FRocket_admin'); ?>">
                                                    
                                                </div>
                                                <div class="space10"></div>
                                                <button type="submit" class="btn btn-large btn-primary"><?php echo __('Update password','FRocket_admin'); ?></button>
                                                <?php
                                                echo form_close();
                                                ?>		
                                                <!-- /form elements section -->	
