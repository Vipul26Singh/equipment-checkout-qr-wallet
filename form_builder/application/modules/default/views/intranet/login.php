                                        ...
                                        <div class="widget form-signin">
                                            ...
                                            <div class="widget-body clearfix" style="padding:25px;">
                                                ...
                                                <div class="form-group  clearfix">
                                                        ...
                                                        <input name="username" class="form-control col-md-12" type="text" id="inputEmail" placeholder="Username">
                                                ...
                                                <button type="submit" class="btn btn-large btn-primary"><?php echo __('Sign in','FRocket_admin'); ?></button>
                                                <?php
                                                echo form_close();
                                                ?>		
                                                <!-- /form elements section -->	
